...
public class Banco {
    ...
    public static void inicia(){
        ...
        // Lista de Jogos
        Jogos jogos1 = new Jogos(1, "Joaozinho", "Salao de Futsal Aleatorio 1", "12/10/2022", 12, "Nenhuma");
        Jogos jogos2 = new Jogos(2, "Kleber", "Campo aberto Aleatorio 2", "21/03/2022", 24, "Nenhuma");
        Jogos jogos3 = new Jogos(3, "Pedro", "Salao de Futsal Aleatorio 2", "23/08/2022", 8, "Trazer propria agua pois nao tem no local");
        Jogos jogos4 = new Jogos(4, "Ruan", "Quadra Anhembi", "14/06/2022", 12, "Trazer bola");
        Jogos jogos5 = new Jogos(5, "Joaozinho2", "Salao de Futsal Aleatorio 3", "30/10/2022", 12, "Nenhuma");
        Jogos jogos6 = new Jogos(6, "Matheus", "Quadra Anhembi Mooca", "08/07/2022", 24, "Nenhuma");
